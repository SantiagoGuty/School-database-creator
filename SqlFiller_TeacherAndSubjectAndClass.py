...
#INSERT INTO projectschool.class (ClassID, ClassName, TeacherID, SubjectID)
#VALUES (1, 'Math', 1, 1);
def printing(apellidos, nombres, departamento, direcion, date, tema, nose, classNum):
    ...
    for professor in range(1, cuantosProfesores ):
        ...
        print("(" + str(professor) + ", \""+ classNum[professor] + "\", " + str(int(random.random() * 40)) + ", " + str(int(random.random() * 40)) + "),")
...
printing(apellidos, nombres, departamento, direcion, dates, topic, Nose, ClassName)